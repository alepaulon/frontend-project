  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-6 text-center lg:items-start lg:space-y-2 lg:text-start xl:max-w-xl xl:flex-col">
        <h1 className="w-[280px] text-3xl font-semibold sm:w-[500px] xl:w-[555px] xl:text-5xl/relaxed">
          Want anything to be easy with{" "}
          <span className="font-bold">Lasles VPN.</span>
        </h1>
        <div className="sm:flex sm:flex-row sm:space-x-6 lg:flex-col lg:space-x-0 lg:space-y-4">
